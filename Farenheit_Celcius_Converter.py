...
#    CS119T – Unit 1-Submission Node – Convert Fahrenheit to Celcius
...
while True:
    ...
    ftemp = float(input("Please enter the Fahrenheit temperature you wish to be converted to Celcius: ")) # Prompt for user to enter Fahrenheit temperature to be converted to Celcius.
    ...
    firstcalc = ftemp - x # First operation needed to convert Celcius Fahrenheit.

    seccalc = y / z # Second operation needed to convert Celcius Fahrenheit.

    ctemp = seccalc * firstcalc # Third and final operation needed to convert user provided Fahrenheit temperature to Celcius temprature.

    print(ftemp, "degrees Fahrenheit converts to", ctemp, "degrees Celcius.") # Shows the user the result of temperature conversion.
